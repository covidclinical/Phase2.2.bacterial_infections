...
## CHECK8: make sure that the concept_type values for ICD10 look all the same
```{r}
...
## CHECK9: how many inpatients with ICD codes since admission in the age range are present in the 3 input files?
```{r}
