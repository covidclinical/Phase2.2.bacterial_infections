...
for( i in 1:length( files )){
  ...
  rm( a2_age_all, a2_sex_all, a2_total_all, a2_age_bacterial, a2_sex_bacterial,
      a2_lengthHosp_all, a2_lengthHosp_bacterial,
      a2_total_bacterial, a2_bact_infection, a2_icu_mortality )
...
for( i in 1:length( files )){
  ...
  rm( a1_age_all, a1_sex_all, a1_total_all, a1_age_bacterial, a1_sex_bacterial,
      a1_lengthHosp_all, a1_lengthHosp_bacterial,
      a1_total_bacterial, a1_bact_infection, a1_icu_mortality )
...
```{r}
save(a1_all_to_work, file = "/4ceData/bacterial_aggregate_ouputs/a1_all_to_work.RData")
save(a2_all_to_work, file = "/4ceData/bacterial_aggregate_ouputs/a2_all_to_work.RData")
```
