...
Create the barplots
```{r}
bacterial_counts_bySite$site <- factor(bacterial_counts_bySite$site, levels = c("BCH","CCMC", "Michigan", "H12O", "HCUV", "GOSH"))
...
```{r, eval=FALSE}
valuesToPlot$site <- factor(valuesToPlot$site, levels = c("BCH","CCMC", "Michigan", "H12O", "HCUV", "GOSH"))
