...
folder_4ce_files <- "/4ceData/Input/AllAdminJuly2023/"
obfuscation =  FALSE
#obfuscation = 3
dateFormat <- "%Y-%m-%d"
...
icd10Codes <- read.csv("../public-data/ICD_bacterial5.csv", header = TRUE, colClasses = "character") %>%
   ...
   dplyr::select( disorder_group = syndrome, concept_code, 
...
obs_raw_age <- left_join(obs_raw, demo_raw[c("patient_num", "age", "ageAtAdmission")], by = c("patient_num")) %>%
