...
## Table A1 counts per cohort: 

### Any hospital admissions

Total counts: 
```{r}
source("../R/A1_tablesPerCohort.R")
a1_total_all <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "total", type = "all")
a1_total_all
```
...
- mortality (y/n) 
```{r}
a1_age_all <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "age_group", type = "all")
a1_sex_all <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "sex", type = "all")
a1_season_all <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "season", type = "all")
a1_lengthHosp_all <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "length_hospitalization_category", type = "all")
a1_icu_all <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "icu_in_hosp", type = "all")
a1_mortality_all <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "dead_in_hosp", type = "all")
```
### Bacterial Infection hospital admissions

Total counts: 
```{r}
a1_total_bacterial <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "total", type = "bacterial")
a1_total_bacterial
```
...
- mortality (y/n) 
```{r}
a1_age_bacterial <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "age_group", type = "bacterial")
a1_sex_bacterial <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "sex", type = "bacterial")
a1_season_bacterial <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "season", type = "bacterial")
a1_lengthHosp_bacterial <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "length_hospitalization_category", type = "bacterial")
a1_icu_bacterial <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "icu_in_hosp", type = "bacterial")
a1_mortality_bacterial <- a1_tablesPerCohort( input_df = all_codes_desc, subcategory = "dead_in_hosp", type = "bacterial")
```
...
- respiratory 
```{r}
a1_subgroups <- a1_tablesPerCohort_subgroup( input_df = all_codes_desc, subcategory = "total")
a1_subgroups
```
Grouped by: 
- age category
...
- mortality (y/n) 
```{r}
a1_age_subgroups <- a1_tablesPerCohort_subgroup( input_df = all_codes_desc, subcategory = "age_group")
a1_sex_subgroups <- a1_tablesPerCohort_subgroup( input_df = all_codes_desc, subcategory = "sex")
a1_season_subgroups <- a1_tablesPerCohort_subgroup( input_df = all_codes_desc, subcategory = "season")
a1_lengthHosp_subgroups <- a1_tablesPerCohort_subgroup( input_df = all_codes_desc, subcategory = "length_hospitalization_category")
a1_icu_subgroups <- a1_tablesPerCohort_subgroup( input_df = all_codes_desc, subcategory = "icu_in_hosp")
a1_mortality_subgroups <- a1_tablesPerCohort_subgroup( input_df = all_codes_desc, subcategory = "dead_in_hosp")
```
### By each bacterial infection
```{r}
source("../R/A1_tablesPerCohort.R")
a1_bact_infection <- a1_tablesPerCohort_bacterialInfection( input_df = all_codes_desc, subcategory = "total")
a1_bact_infection
```
Grouped by: 
- age category
...
- mortality (y/n) 
```{r}
a1_age_bact_infection <- a1_tablesPerCohort_bacterialInfection( input_df = all_codes_desc, subcategory = "age_group")
a1_sex_bact_infection <- a1_tablesPerCohort_bacterialInfection( input_df = all_codes_desc, subcategory = "sex")
a1_season_bact_infection <- a1_tablesPerCohort_bacterialInfection( input_df = all_codes_desc, subcategory = "season")
a1_lengthHosp_bact_infection <- a1_tablesPerCohort_bacterialInfection( input_df = all_codes_desc, subcategory = "length_hospitalization_category")
a1_icu_bact_infection <- a1_tablesPerCohort_bacterialInfection( input_df = all_codes_desc, subcategory = "icu_in_hosp")
a1_mortality_bact_infection <- a1_tablesPerCohort_bacterialInfection( input_df = all_codes_desc, subcategory = "dead_in_hosp")
```
